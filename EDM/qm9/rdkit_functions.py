...
import pickle
import os
# Disable RDKit logger completely
...
def compute_qm9_smiles(dataset_name, remove_h):
    ...
    class StaticArgs:
        def __init__(self, dataset, remove_h):
            ...
            self.datadir = '../processed_dataset/qm9'
...
def retrieve_qm9_smiles(dataset_info):
    ...
    file_name = '../processed_dataset/qm9/%s_smiles.pickle' % pickle_name
    try:
        ...
        try:
            os.makedirs('../processed_dataset/qm9')
        except:
            pass
